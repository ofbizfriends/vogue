...
<form id="glReconciledFinAccountTrans" name="glReconciledFinAccountTransForm" method="post" action="<@ofbizUrl>callReconcileFinAccountTrans?clearAll=Y</@ofbizUrl>">
  ...
  <div class="screenlet">
    ...
    <div class="screenlet-body">
      <a href="<@ofbizUrl>EditFinAccountReconciliations?finAccountId=${finAccountId}&amp;glReconciliationId=${glReconciliationId}</@ofbizUrl>" class="btn btn-link">${uiLabelMap.CommonEdit}</a>
      ...
      <#if finAcctTransCondList?has_content>
        <a href="javascript:document.CancelBankReconciliationForm.submit();" class="btn btn-link">${uiLabelMap.AccountingCancelBankReconciliation}</a>
      </#if>
          ...
          <#list finAccountTransList as finAccountTrans>
            ...
            <tr valign="middle"<#if alt_row> class="alternate-row"</#if>>
              ...
              <#if finAccountTrans.statusId == "FINACT_TRNS_CREATED">
                <td align="center"><a href="javascript:document.reomveFinAccountTransAssociation_${finAccountTrans.finAccountTransId}.submit();" class="btn btn-link">${uiLabelMap.CommonRemove}</a></td>
              <#else>
                <td/>
              </#if>
              <#if finAccountTrans.paymentId?has_content>
                <td align="center">
                  <a id="toggleGlTransactions_${finAccountTrans.finAccountTransId}" href="javascript:void(0)" class="btn btn-link">${uiLabelMap.FormFieldTitle_glTransactions}</a>
