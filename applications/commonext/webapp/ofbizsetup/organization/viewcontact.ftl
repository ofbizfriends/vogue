              ...
              <td>
                ...
                <#if "POSTAL_ADDRESS" = contactMech.contactMechTypeId>
                  ...
                  <#if postalAddress.geoPointId?has_content>
                    ...
                    <a href="javascript:popUp('<@ofbizUrl>geoLocation?geoPointId=${postalAddress.geoPointId}</@ofbizUrl>', '${popUptitle!}', '450', '550')" class="btn btn-link">${uiLabelMap.CommonGeoLocation}</a>
                  </#if>
                ...
                <#elseif "EMAIL_ADDRESS" = contactMech.contactMechTypeId>
                  <div>
                    ...
                    <#--a href="<@ofbizUrl>EditCommunicationEvent?partyIdFrom=${userLogin.partyId}&amp;partyIdTo=${partyId}&amp;communicationEventTypeId=EMAIL_COMMUNICATION&amp;contactMechIdTo=${contactMech.contactMechId}&amp;contactMechTypeId=EMAIL_ADDRESS<#if thisUserPrimaryEmail?has_content>&amp;contactMechIdFrom=${thisUserPrimaryEmail.contactMechId}</#if></@ofbizUrl>" class="btn btn-link">${uiLabelMap.CommonSendEmail}</a-->
                  </div>
