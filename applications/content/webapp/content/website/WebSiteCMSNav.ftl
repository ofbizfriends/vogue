...
<div id="subsites"></div>
<#if (!subsites?has_content)>
    <a href="javascript:void(0);" class="btn btn-link">${uiLabelMap.ContentWebSiteAddTree}</a>
</#if>
<div class="label">
...
<div id="menus"></div>
<#if (!menus?has_content)>
    <a href="javascript:void(0);" class="btn btn-link">${uiLabelMap.ContentWebSiteAddMenu}</a>
</#if>
...
<div id="errors"></div>
<#if (!errors?has_content)>
    <a href="javascript:void(0);" class="btn btn-link">${uiLabelMap.ContentWebSiteAddError}</a>
</#if>
