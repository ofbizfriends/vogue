    ...
    <div>
      <#if sessionAttributes.userLogin?has_content && sessionAttributes.userLogin.userLoginId != "anonymous">
        ...
        <form name="addToShoppingList" method="post" action="<@ofbizUrl>addItemToShoppingList<#if requestAttributes._CURRENT_VIEW_??>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>">
          ...
          &nbsp;&nbsp;
          <input type="text" size="5" name="quantity" value="1" />
          <a href="javascript:document.addToShoppingList.submit();" class="btn btn-link">[${uiLabelMap.OrderAddToShoppingList}]</a>
        </form>
      <#else> <br />
      ...
      <form name="configform" id="configFormId" method="post" action="<@ofbizUrl>product<#if requestAttributes._CURRENT_VIEW_??>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>">
        ...
        <table >
          <tr>
            <td>
                <div>
                    <a href="javascript:verifyConfig();" class="btn btn-link">${uiLabelMap.OrderVerifyConfiguration}</a>
                </div>
            </td>
          </tr>
          <tr><td><hr /></td></tr>
            ...
            <td>
              ...
              <#if question.isFirst()>
                ...
                <#if instructions?has_content>
                  <a href="javascript:showErrorAlert("${uiLabelMap.CommonErrorMessage2}","${instructions}");" class="btn btn-link">Instructions</a>
                </#if>
              ...
              <#else>
                <div><a href='#${question.getConfigItem().getString("configItemId")}' class="btn btn-link">Details</a></div>
              </#if>
            </td>
          </tr>
          <tr>
