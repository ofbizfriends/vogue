...
<form name="keywordsearchform" id="keywordSearchForm" method="post" action="<@ofbizUrl>keywordsearch?VIEW_SIZE=25&amp;PAGING=Y</@ofbizUrl>">
  <fieldset>
    ...
    <div>
      <input type="submit" name="find" value="${uiLabelMap.CommonFind}" class="btn btn-link" />
    </div>
    </fieldset>
</form>
<form name="advancedsearchform" id="advancedSearchForm" method="post" action="<@ofbizUrl>advancedsearch</@ofbizUrl>">
  <fieldset>
    ...
    <div>
    <a href="javascript:document.getElementById('advancedSearchForm').submit()" class="btn btn-link">${uiLabelMap.ProductAdvancedSearch}</a>
    </div>
  </fieldset>
</form>
