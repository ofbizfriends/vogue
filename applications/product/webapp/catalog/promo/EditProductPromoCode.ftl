            ...
            <#list productPromoCodeEmails as productPromoCodeEmail>
              <div>
                <form name="deleteProductPromoCodeEmail_${productPromoCodeEmail_index}" method="post" action="<@ofbizUrl>deleteProductPromoCodeEmail</@ofbizUrl>">
                  ...
                  <a href='javascript:document.deleteProductPromoCodeEmail_${productPromoCodeEmail_index}.submit()' class='btn btn-link'>${uiLabelMap.CommonRemove}</a>&nbsp;${productPromoCodeEmail.emailAddress}
                </form>
              </div>                
            </#list>
            <div>
    ...
    <div class="screenlet">
        ...
        <div class="screenlet-body">
            <#list productPromoCodeParties as productPromoCodeParty>
                <div><a href="<@ofbizUrl>deleteProductPromoCodeParty?productPromoCodeId=${productPromoCodeParty.productPromoCodeId}&amp;partyId=${productPromoCodeParty.partyId}&amp;productPromoId=${productPromoId}</@ofbizUrl>" class="btn btn-link">X</a>&nbsp;${productPromoCodeParty.partyId}</div>
            </#list>
            <div>
