          ...
          <tr>
            ...
            <td valign="top">
              ...
              <#if "POSTAL_ADDRESS" = contactMech.contactMechTypeId>
                  ...
                  <#if (postalAddress?has_content && !postalAddress.countryGeoId?has_content) || postalAddress.countryGeoId = "USA">
                      ...
                      <#if (addr1.indexOf(" ") > 0)>
                        ...
                        <br /><a target='_blank' href='${uiLabelMap.CommonLookupWhitepagesAddressLink}' class='btn btn-link'>${uiLabelMap.CommonLookupWhitepages}</a>
                      </#if>
                  </#if>
                  <#if postalAddress.geoPointId?has_content>
                    ...
                    <br /><a href="javascript:popUp('<@ofbizUrl>geoLocation?geoPointId=${postalAddress.geoPointId}</@ofbizUrl>', '${popUptitle!}', '450', '550')" class="btn btn-link">${uiLabelMap.CommonGeoLocation}</a>
                  </#if>
              <#elseif "TELECOM_NUMBER" = contactMech.contactMechTypeId>
                  <#assign telecomNumber = contactMechMap.telecomNumber>
                    ...
                    <#if (telecomNumber?has_content && !telecomNumber.countryCode?has_content) || telecomNumber.countryCode = "011">
                      <br /><a target='_blank' href='${uiLabelMap.CommonLookupAnywhoLink}' class='btn btn-link'>${uiLabelMap.CommonLookupAnywho}</a>
              ...
              <#elseif "EMAIL_ADDRESS" = contactMech.contactMechTypeId>
                    ...
                    <a href='mailto:${contactMech.infoString!}' class='btn btn-link'>${uiLabelMap.CommonSendEmail}</a>
