...
<hr />
  ...
  <form method="post" action="<@ofbizUrl>entityImport</@ofbizUrl>">
    ...
    <div class="btn-group"><input type="submit" value="${uiLabelMap.WebtoolsImportFile}"/></div>
  </form>
  <form method="post" action="<@ofbizUrl>entityImport</@ofbizUrl>">
    ...
    <div class="btn-group"><input type="submit" value="${uiLabelMap.WebtoolsImportText}"/></div>
  </form>
  <#if messages??>
      <hr />
