...
<#macro displayProductImages>
	<#if productImageList?has_content>
	    ...
	    <div id="mainImage" >
	        ...
	        <#if productLargeImageUrl?string?has_content>
	            <img src="<@ofbizContentUrl>${contentPathPrefix!}${productLargeImageUrl!}</@ofbizContentUrl>" class="img-responsive" alt="" />
	        <#else>                
	            <img src="/images/defaultImage.jpg" class="img-responsive" alt="" />
	        </#if>
	    </div>
	...
	<#else>
	    ...
	    <div id="mainImage">
	        ...
	        <#if productLargeImageUrl?string?has_content>
	            <a href="javascript:popupDetail();"><img id="detailImage" src="<@ofbizContentUrl>${contentPathPrefix!}${productLargeImageUrl!}</@ofbizContentUrl>" class="img-responsive" alt="" /></a>
	        ...
	        <#if !productLargeImageUrl?string?has_content>
	            <img id="detailImage" src="/images/defaultImage.jpg" alt="" />
	        </#if>
	    </div>
	    <#if price.isSale?? && price.isSale>
	        <div class="ribbon sale">
	        ...
	        <#else>
	            <#if productStore??>
	                <#if productStore.requireInventory?? && productStore.requireInventory == "N">
	                    <span><input name="quantity" id="quantity" type="hidden" <#if product.isVirtual!?upper_case == "Y">disabled="disabled"</#if> /></span><a href="javascript:addItem()" id="addToCart" name="addToCart" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> ${uiLabelMap.OrderAddToCart}</a>
	                    <@showUnavailableVarients/>
	                <#else>
	                    <span><input name="quantity" id="quantity" value="1"  type="hidden" disabled="disabled" /></span><a href="javascript:void(0);" disabled="disabled" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> ${uiLabelMap.OrderAddToCart}</a><br />
