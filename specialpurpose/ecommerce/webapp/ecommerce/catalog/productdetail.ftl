...
<#macro productDetailDesc >
	<div id="productDetailDesc" class="row">    
	    <#-- Long description of product -->
	    <div class="col-md-12">   
		    <div id="long-description" class="box">
	    ...
	    <div class="col-md-12">        
	        <div class="row product-tags">
	            <div class="col-md-3 col-sm-6">
	                <div class="box">
	                    <h3>${uiLabelMap.EcommerceProductTags}</h3>
...
<#macro associated assocProducts beforeName showName afterName formNamePrefix targetRequestName>
    ...
    <#if assocProducts?has_content>
        <div class="row">
            <div class="col-md-3 col-sm-6">
                <div class="box">
                    <h3>${beforeName!}<#if showName == "Y">${productContentWrapper.get("PRODUCT_NAME")!}</#if>${afterName!}</h3>
                </div>
            </div>   
            ...
            <div class="productsummary-container">
                <#list assocProducts as productAssoc>
                    ...
                    <#--
                    <div>
                        <a href="<@ofbizUrl>${targetRequest}/<#if categoryId??>~category_id=${categoryId}/</#if>~product_id=${assocProductId}</@ofbizUrl>" class="btn btn-primary">
                            ${assocProductId}
                        </a>
...
<#macro displayProductImages>
	<#if productImageList?has_content>
	    ...
	    <div id="mainImage" >
	        ...
	        <#if productLargeImageUrl?string?has_content>
	            <img src="<@ofbizContentUrl>${contentPathPrefix!}${productLargeImageUrl!}</@ofbizContentUrl>" name="mainImage" class="img-responsive" alt="" />
	        <#else>                
	            <img src="/images/defaultImage.jpg" name="mainImage" class="img-responsive" alt="" />
	        </#if>
	    </div>
	    ...
	    <#-- Show Additional Image Approved -->
	    <#if productImageList?has_content>
	        <br/>
	        <div id="thumbs" class="row">
	            <div class="col-xs-12">
	                <div class="col-xs-3">
	                    <a href="<@ofbizContentUrl>${contentPathPrefix!}${productLargeImageUrl!}</@ofbizContentUrl>" class="thumb">
	                        <img src="<@ofbizContentUrl>${contentPathPrefix!}${productLargeImageUrl!}</@ofbizContentUrl>" alt="" class="img-responsive">
	                    </a>
	                </div>
	                <#list productImageList as productImage>
	                <div class="col-xs-3">
	                    <a href="<@ofbizContentUrl>${productImage.productImageThumb}</@ofbizContentUrl>" class="thumb">
	                        <img src="<@ofbizContentUrl>${productImage.productImageThumb}</@ofbizContentUrl>" alt="" class="img-responsive">
	                    </a>
	                </div>
	                </#list>
	            </div>
	...
	<#else>
	    ...
	    <div id="mainImage">
	        ...
	        <#if productLargeImageUrl?string?has_content>
	            <a href="javascript:popupDetail();"><img id="detailImage" src="<@ofbizContentUrl>${contentPathPrefix!}${productLargeImageUrl!}</@ofbizContentUrl>" name="mainImage" vspace="5" hspace="5" class="img-responsive" alt="" /></a>
	    ...
	    <div id="thumbs" class="row">
	        <div class="col-xs-12">
	            <#if productAdditionalImage1?string?has_content>
	                <div class="col-xs-3">
	                    <a href="<@ofbizContentUrl>${productAdditionalImage1}</@ofbizContentUrl>" class="thumb">
	                       <img src="<@ofbizContentUrl>${productAdditionalImage1}</@ofbizContentUrl>" class="img-responsive" alt="" />
	                    </a>
	                </div>
	            </#if>
	            <#if productAdditionalImage2?string?has_content>
	                <div class="col-xs-3">
	                    <a href="<@ofbizContentUrl>${productAdditionalImage1}</@ofbizContentUrl>" class="thumb">
	                       <img src="<@ofbizContentUrl>${productAdditionalImage2}</@ofbizContentUrl>"  class="img-responsive" alt="" />
	                    </a>
	                </div>
	            </#if>
	            <#if productAdditionalImage3?string?has_content>
	                <div class="col-xs-3">
	                    <a href="<@ofbizContentUrl>${productAdditionalImage1}</@ofbizContentUrl>" class="thumb">
	                       <img src="<@ofbizContentUrl>${productAdditionalImage3}</@ofbizContentUrl>" class="img-responsive" alt="" />
	                    </a>
	                </div>
	            </#if>
	            <#if productAdditionalImage4?string?has_content>
	                <div class="col-xs-3">
	                    <a href="<@ofbizContentUrl>${productAdditionalImage1}</@ofbizContentUrl>" class="thumb">
	                       <img src="<@ofbizContentUrl>${productAdditionalImage4}</@ofbizContentUrl>"  class="img-responsive" alt="" />
	                    </a>
	                </div>
	            </#if>
	        </div>
		    ...
		    <fieldset>
		        ...
		        <#if product.isVirtual!?upper_case == "Y">
		            <#if product.virtualVariantMethodEnum! == "VV_FEATURETREE" && featureLists?has_content>
		                ...
		                <div id="addCart1" style="display:none;">
		                    ...
		                    <a href="javascript:javascript:addItem();" class="btn btn-primary"><span style="white-space: nowrap;"><i class="fa fa-shopping-cart"></i> ${uiLabelMap.OrderAddToCart}</span></a>		                  
		                </div>
		        ...
		        <#else>
		            ...
		            <#if mainProducts?has_content>
		                ...
		                <select name="productVariantId" onchange="javascript:displayProductVirtualVariantId(this.value);" class="form-control">
		        ...
		        <#if product.introductionDate?? && nowTimestamp.before(product.introductionDate)>
		            ...
		            <div class="text-danger">${uiLabelMap.ProductProductNotYetMadeAvailable}.</div>
		            <#-- check to see if salesDiscontinuationDate has passed -->
		        <#elseif product.salesDiscontinuationDate?? && nowTimestamp.after(product.salesDiscontinuationDate)>
		            <div class="text-danger">${uiLabelMap.ProductProductNoLongerAvailable}.</div>
		        ...
		        <#elseif product.virtualVariantMethodEnum! != "VV_FEATURETREE">
		            ...
		            <#else>
		                <span><input name="quantity" id="quantity" value="1" size="4" maxLength="4" type="hidden" <#if product.isVirtual!?upper_case == "Y">disabled="disabled"</#if> /></span><a href="javascript:addItem()" id="addToCart" name="addToCart" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> ${uiLabelMap.OrderAddToCart}</a>
		        ...
		        <#else>
		            <#if productStore??>
		                <#if productStore.requireInventory?? && productStore.requireInventory == "N">
		                    ...
		                    <@showUnavailableVarients/>
		                <#else>
		                    <span><input name="quantity" id="quantity" value="1" size="4" maxLength="4" type="hidden" disabled="disabled" /></span><a href="javascript:void(0);" disabled="disabled" class="btn btn-primary"><i class="fa fa-shopping-cart"></i> ${uiLabelMap.OrderAddToCart}</a><br />
...
<#macro shoppingList >
	<div>
	    <#if sessionAttributes.userLogin?has_content && sessionAttributes.userLogin.userLoginId != "anonymous">
	        <hr />
	        <form name="addToShoppingList" method="post" class="form-inline" action="<@ofbizUrl>addItemToShoppingList<#if requestAttributes._CURRENT_VIEW_??>/${requestAttributes._CURRENT_VIEW_}</#if></@ofbizUrl>">
	            <fieldset>
	                <input type="hidden" name="productId" value="${product.productId}" />
	                <input type="hidden" name="product_id" value="${product.productId}" />
	                ...
	                <#elseif product.productTypeId! == "ASSET_USAGE_OUT_IN">
	                   ${uiLabelMap.CommonStartDate} (yyyy-mm-dd)&nbsp;&nbsp;&nbsp;<@htmlTemplate.renderDateTimeField name="reservStartStr" event="" action="" value="${startDate}" className="" alert="" title="Format: yyyy-MM-dd HH:mm:ss.SSS" size="15" maxlength="30" id="reservStartStr" dateType="date" shortDateInput=false timeDropdownParamName="" defaultDateTimeString="" localizedIconTitle="" timeDropdown="" timeHourName="" classString="" hour1="" hour2="" timeMinutesName="" minutes="" isTwelveHour="" ampmName="" amSelected="" pmSelected="" compositeType="" formName=""/>&nbsp;&nbsp;Number of&nbsp;days&nbsp;&nbsp;<input type="text" size="4" name="reservLength" /><input type="hidden" size="4" name="reservPersons" value="1" /><br/>
	                    Qty&nbsp;<input type="hidden" size="5" name="quantity" value="1" />
	                <#else>
	                    <input type="hidden" size="5" name="quantity" value="1" />
	    ...
	    <#else>
	        ${uiLabelMap.OrderYouMust} <a href="<@ofbizUrl>checkLogin/showcart</@ofbizUrl>" class="btn btn-link">${uiLabelMap.CommonBeLogged}</a>
	        ${uiLabelMap.OrderToAddSelectedItemsToShoppingList}
	    </#if>
	</div>
</#macro>
<#macro showVirtualProductSwatch >
        ...
        <div class="row">
	        <#list imageKeys as key>
	            ...
	            <#if swatchProduct?has_content && indexer &lt; maxIndex>
	                ...
	                <a href="javascript:getList('FT${featureOrderFirst}','${indexer}',1);" class="btn btn-link">${key}</a>
	                <a href="javascript:getList('FT${featureOrderFirst}','${indexer}',1);">
	                <img src="<@ofbizContentUrl>${contentPathPrefix!}${imageUrl}</@ofbizContentUrl>" class="img-responsive" alt="" /></a>                         
	            </#if>
