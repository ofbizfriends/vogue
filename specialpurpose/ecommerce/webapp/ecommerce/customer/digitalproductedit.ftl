...
<#else>
    ...
    &nbsp;<a href="<@ofbizUrl>digitalproductlist</@ofbizUrl>" class="btn btn-link">${uiLabelMap.CommonBackToList}</a>
    ...
    <tr>
      ...
      <td width="5">&nbsp;</td>
      <td width="74%"><a href="javascript:document.editdigitaluploadform.submit()" class="btn btn-link">${uiLabelMap.CommonSave}</a></td>
    </tr>
  </table>
  </form>
</#if>
...
<div class="screenlet">
    ...
    <div class="screenlet-body">
        ...
        <form method="post" action="<@ofbizUrl>addCustomerDigitalDownloadProductFile</@ofbizUrl>" name="adddigitaluploadfile" style="margin: 0;">
          ...
          <a href="javascript:document.adddigitaluploadfile.submit()" class="btn btn-link">${uiLabelMap.CommonAdd}</a>
        </form>
        </div>
    &nbsp;<a href="<@ofbizUrl>digitalproductlist</@ofbizUrl>" class="btn btn-link">${uiLabelMap.CommonBackToList}</a>
    </div>
