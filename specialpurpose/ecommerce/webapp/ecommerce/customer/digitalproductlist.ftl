...
<div class="screenlet">
    ...
    <div class="screenlet-body">
       <div>&nbsp;<a href="<@ofbizUrl>digitalproductedit</@ofbizUrl>" class="btn btn-link">${uiLabelMap.EcommerceDigitalNewProduct}</a></div>
        <table width="100%" cellpadding="1" cellspacing="0" border="0">
          ...
          <#list supplierProductList as supplierProduct>
            ...
            <tr>
              ...
              <td width="5">&nbsp;</td>
              <td align="right">
                <a href="<@ofbizUrl>digitalproductedit?productId=${supplierProduct.productId}&amp;currencyUomId=${supplierProduct.currencyUomId}&amp;minimumOrderQuantity=${supplierProduct.minimumOrderQuantity}&amp;availableFromDate=${supplierProduct.availableFromDate}</@ofbizUrl>" class="btn btn-link">Edit</a>
              </td>
            </tr>
          </#list>
