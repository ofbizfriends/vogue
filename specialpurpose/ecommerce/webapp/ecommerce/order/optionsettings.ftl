	    ...
	    <div class="col-md-6">                        
	        ...
	        <fieldset>
	            <div class="form-group">
	                ...
	                <textarea cols="30" rows="3" class="form-control" name="shipping_instructions">${shoppingCart.getShippingInstructions()!}</textarea>
	            </div>
	            <div class="form-group">
	                <label for="correspondingPoId">${uiLabelMap.OrderPoNumber}</label>
	                <input type="text" class="form-control" name="correspondingPoId" value="${shoppingCart.getPoNumber()!}"/>
	            </div>
	        </fieldset>
	        <#if productStore.showCheckoutGiftOptions! != "N">
	            <fieldset><legend>${uiLabelMap.OrderIsThisGift}</legend>
	                ...
	                <div class="form-group">
	                    ...
	                    <textarea class="form-control" name="gift_message">${shoppingCart.getGiftMessage()!}</textarea>
	                </div>
	            </fieldset>
	        </#if>
	    </div><!-- ./col-md-6 -->
