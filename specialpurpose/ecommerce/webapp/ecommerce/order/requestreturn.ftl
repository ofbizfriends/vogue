    ...
    <div class="screenlet-body">
        <form name="selectAllForm" method="post" action="<@ofbizUrl>requestReturn</@ofbizUrl>">
          ...
          <table border="0" width="100%" cellpadding="2" cellspacing="0">
            <tr>
              <td colspan="5"><h3>${uiLabelMap.OrderReturnItemsFromOrder} ${uiLabelMap.CommonNbr}<a href="<@ofbizUrl>orderstatus?orderId=${orderId}</@ofbizUrl>" class="btn btn-link">${orderId}</h3></td>
              <td align="right">
            ...
            <#if returnableItems?has_content>
                  ...
                  <td>
                    <div>
                      <#if orderItem.productId??>
                        &nbsp;<a href="<@ofbizUrl>product?product_id=${orderItem.productId}</@ofbizUrl>" class="btn btn-link">${orderItem.productId}</a>
              ...
              <tr>
                <td colspan="6" align="right">
                  <a href="javascript:document.selectAllForm.submit();" class="btn btn-link">${uiLabelMap.OrderReturnSelectedItems}</a>
                </td>
              </tr>
            <#else>
