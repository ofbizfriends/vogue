      ...
      <div class="row clearfix copyright">
        ...
        <div class="col-xs-12 col-sm-6 col-md-8 col-lg-8 social-icon">
          <ul class="list-unstyled list-inline">
            <li><a href="https://www.facebook.com/ofbizfriends" target="_BLANK"><i class="fa fa-facebook bigger-150"></i></a></li>            
            <#--
            <li><a href="#" target="_BLANK" ><i class="fa fa-google-plus bigger-150"></i></a></li>
            -->
            <li><a href="http://www.youtube.com/user/ofbizfriends" target="_BLANK"><i class="fa fa-youtube bigger-150"></i></a></li>
          </ul>
        </div><!-- /.social-icon -->
        <div class="col-xs-12 col-sm-6 col-md-4 col-lg-4 copyright-text">
          <p ><strong>VOGUE</strong> &copy; ${nowTimestamp?string("yyyy")} . Powered by <a href="http://ofbiz.apache.org" target="_blank">OFBiz</a></p>
        </div>
      </div><!-- /.copyright -->
    </div>
  </div>